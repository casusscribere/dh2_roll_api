...
npm test           # 311 tests (engine + pipeline + DSL + docs + rules content + character schema/adapters + phase0–5 suites + fire modes + name normalization + dependencies + crit table + weapon data + HTTP endpoints)
